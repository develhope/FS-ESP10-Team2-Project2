...
- [ ] **1.** Implementar un sistema automático de evaluación de precio en monedas para cada Pokémon basado en sus propiedades más relevantes.
  ...
  - [ ] **1.1** Sistema al inicializar la clase [`PokemonManager`](templates/pokedex/js/models/PokemonManager.js) para mostrar ofertas aleatorias en los precios de algunos Pokémon.
